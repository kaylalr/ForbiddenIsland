...
class GiveTreasureCardView {
    ...
    void displayGiveTreasureCardView() {
        ...
        do {
            ...
            endOfView = doActions(inputs, player1, player2, totalEarth, totalWind, totalFire, totalWater, p1Earth, p2Earth, p1Wind, p2Wind, p1Fire, p2Fire, p1Water, p2Water);

        } while (endOfView != true);
    }

    private String[] getInputs(boolean player1, boolean player2, int totalEarth, int totalWind, int totalFire, int totalWater, int p1Earth, int p2Earth, int p1Wind, int p2Wind, int p1Fire, int p2Fire, int p1Water, int p2Water) {
        // test code
    ...
    private boolean doActions(String[] inputs, boolean player1, boolean player2, int totalEarth, int totalWind, int totalFire, int totalWater, int p1Earth, int p2Earth, int p1Wind, int p2Wind, int p1Fire, int p2Fire, int p1Water, int p2Water) {
        switch (inputs[0]) {
            case "E":
                if (player2 == true) {
                    if (p2Earth == 0) {
